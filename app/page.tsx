...
useEffect(() => {
 ...
 useEffect(() => {
  ...
  <div className="relative group cursor-pointer">
    <span onClick={() => setShowContact(false)} 
    className="hover:text-blue-600">
...
>
  <div className="flex flex-col h-full p-6">
    ...
    <div className="flex justify-between items-center mb-6">
      <a className="font-bold text-blue-900">DOTHREE</a>
  ...
  {lang === "id" ? "Kontak" : "Contact"}
    ...
    <div className="mt-10">
      ...
      <div className="flex gap-2">
        <button onClick={() => setLang("en")} className="border px-3 py-1">
          EN
        </button>

        <button onClick={() => setLang("id")} className="bg-red-500 text-white px-3 py-1">
          ID
        </button>
      </div>
    </div>
      ...
      {/* HERO */}
     <section className="w-full bg-blue-900 text-white text-center py-20 px-4 md:px-10">
    <h1 className="text-3xl md:text-5xl font-bold">DOTHREE</h1>
    <p className="mt-2 text-sm md:text-base">Trusted IT Partner</p>
  </section>
...
<section id="about" className="w-full">
  ...
  {/* TOP HERO ABOUT */}
  <div className="relative h-[2200px] md:h-[300px] flex items-center justify-center text-center">
...
<section id="services" className="py-16 PX-4 BG-GRAY-100 text-center">
  ...
  <div className="GRID grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
   ...
   {/* CLIENT SLIDER */}
<section id="clients" ref={clientRef} className="w-full py-12">
          ...
          <div key={i} className="min-w-full flex justify-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-4">
              ...
              {group.map((client, j) => (
                <div
                  key={j}
                  className="w-full max-w-[160px] h-[100px] flex items-center justify-center bg-white rounded-xl shadow hover:scale-105 hover:shadow-lg transition"
                >
                  <Image
                    src={`/clients/${client}`}
                    alt={client}
...
{!showContact && (
  <footer className="w-full bg-blue-900 text-white py-6 px-4 md:px-10 border-t border-white/20">
...
{/* FOOTER */}
<footer className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white text-center py-4">
